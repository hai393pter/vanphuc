...
config.ToolbarSets["Normal"] = [	
	['Preview','-','Cut','Copy','Paste','-','Print','SpellCheck','Find','Replace','-','Undo','Redo','-','Link','RemoveLink','-','Image','Table','-','Bold','Italic','Underline','StrikeThrough','About'] ,
	['Subscript','Superscript','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','InsertOrderedList','InsertUnorderedList','Outdent','Indent','Zoom','FontStyleAdv','FontStyle'] ,
	['FontFormat','-','Font','-','FontSize','-','TextColor','BGColor']
] ;

config.ToolbarSets["Upload"] = [	
	['Image','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','StrikeThrough','-','TextColor','BGColor']
] ;
