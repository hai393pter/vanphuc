...
function ok()
{	
	window.setImage(sImagesPath+list.dsanh.value) ;
	window.close() ;
}
function doUnUpload()
{
...
-->
	...
	<BODY bgcolor="#EFF8FF">
		<TABLE height="100%" cellspacing="0" cellpadding="0" width="100%" border="0">
		    <TR><TD align="center"><iframe src="frmupload.php" width="100%" height="60" frameborder="0"></iframe></TD>
			</TR>
			<TR>
				<TD height="100%">
			...
			<TR>
				<TD valign="bottom" align="middle">
				    <input type="button" class="formButton"  onClick="doUnUpload()" value="X&#243;a &#7843;nh">
				    &nbsp;&nbsp;&nbsp;&nbsp;
					<INPUT type="button" class="formButton" style="WIDTH: 80px"     onclick="ok();" value="Ch&#7885;n &#7843;nh"> 
					&nbsp;&nbsp;&nbsp;&nbsp;
					<INPUT type="button" class="formButton" style="WIDTH: 80px" onclick="window.close();" value="&#272;&#243;ng">
					<BR>
				</TD>
			</TR>
		</TABLE>
