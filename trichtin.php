...
<tr><td><img src="images/dv.jpg" align="center" alt="" border="0"></td></tr>
<tr>
...
if(isset($_GET["id"]))
{
  $src="http://www.vietnamnet.vn".change_back_code($_GET["id"]);
}else $src="http://www.vietnamnet.vn/cntt/";
  ...
  $content=cut_table(5,$content);
	...
	$content=str_replace("src=\"/","src=\"http://www.vietnamnet.vn/",$content);
	$content=str_replace(cut_string("<table",">",$content),"<table width=\"100%\">",$content);
	$content=str_replace("href=\"http://www.vietnamnet.vn","href=\"",$content);
