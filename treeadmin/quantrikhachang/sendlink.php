...
<?php
  ...
  $ten=$rowthongtin["hoten"];
  $diachi=$rowthongtin["diachi"];
  $dt=$rowthongtin["dienthoai"];
  $email=$rowthongtin["email"];
  $message="Register Info:\n";
  $message.="Kinh gui Ong(Ba)".$ten."\n";
  $message.="Dia chia :".$diachi."\n";
  $message.="So dien thoai: ".$dt."\n";
  $message.="Email: ".$email."\n";
  $message.="danh muc san pham ong ba da chon: ".$tel."\n";
  $message.=" ".$fax."\n";
  $message.="http://www.vanphuc.com/treeadmin/quantrikhachang/viewinfo.php?sess=".$sess."\n".$content."\n";
  $headers= "From: ".$email."\r\n";
  $array[0]->smtp_send_email ("cuongdk@kctvietnam.com","cuongdk@kctvietnam.com", "Xac nhan thong tin mua hang!",$message);
  $array[0]->mail_quit ();
  $sql="update thongtinkhachhang set danhan=1 where sess='$sess'";
  mysql_query($sql);
?>
<center>
  <span class="markred">B&#7840;N &#272;&#195; G&#7916;I TH&#431; X&#193;C NH&#7852;N</span><br>
<br><a href="?"></a></center>
</body>
</html>