...
config.ToolbarSets["Normal"] = [	
	['EditSource','-','Cut','Copy','Paste','-','SelectAll','RemoveFormat','-','Link','RemoveLink','-','Image','Rule','Table','ShowTableBorders','InsertOrderedList','InsertUnorderedList','PasteWord','-','Undo','Redo'] ,
	['Font','FontSize','TextColor','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','InsertOrderedList','InsertUnorderedList']

] ;

config.ToolbarSets["Upload"] = [	
	['EditSource','-','Bold','Italic','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','StrikeThrough','InsertUnorderedList','-','TextColor','RemoveFormat']
] ;
...
//## Font Names
//##
config.ToolbarFontNames = ';Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana;Arial' ;
