...
{ 
  ...
  this.nodeImg = 0;
  this.isLastNode = 0;
  this.iconSrc = ICONPATH + "treeadmin_files/ftv2folderopen.gif";
  this.iconSrcClosed = ICONPATH + "treeadmin_files/ftv2folderclosed.gif";
...
function finalizeCreationOfItem(itemArray)
{
  ...
  itemArray.iconSrc = ICONPATH + "treeadmin_files/ftv2doc.gif" 
